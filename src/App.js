            ...
            <div className="App">
                ...
                <section className="content">
                  ...
                  <h4>Mittwoch 05.09. 13:00-15:00 Uhr</h4>
                    <LineItem imgUrl="https://img.rewe-static.de/1171287/21729312_digital-image.png?output-quality=75&fit=inside|240:240"
                    description="Black Premium Rinder-Steakhüfte Irisch"
                    details="1 Stück ca. 200 g (1 kg = 25,90 €)"
                    price={10}
                    amount={1}/>
                    <LineItem imgUrl="https://img.rewe-static.de/0196479/3851190_digital-image.png?output-quality=75&fit=inside|240:240"
                    description="MILKA SCHOKO TAFEL MILCH 100 GR"
                    details="100g"
                    price={2}
                    amount={1}/>
                    <LineItem imgUrl="https://img.rewe-static.de/0570894/2622200_digital-image.png?output-quality=75&fit=inside|240:240"
                    description="TEEKANNE Ind. Chai Classic RFA 20er"
                    details="40g (100 g = 5,48 €)"
                    price={5}
                    amount={1}/>
                    <LineItem imgUrl="https://img.rewe-static.de/0471402/3882110_digital-image.png?output-quality=75&fit=inside|240:240"
                    description="Vollmilch, 3,8% Fett, pasteurisiert, homogenisiert. Länger haltbar."
                    details="1,50l (1 l = 1,26 €)"
                    price={2}
                    amount={1}/>
                    <LineItem imgUrl="https://img.rewe-static.de/1427496/23189253_digital-image.png?output-quality=75&fit=inside|240:240"
