...
class App extends Component {
    constructor(props) {
        ...
        this.goForPayment = this.goForPayment.bind(this)
    }
    ...
    userInputHandler = (event) => {
        ...
        this.state.web3.eth.getAccounts((err, accounts) => {
            ...
            sender.deployed().then((instance) => {
                ...
                return instance.sendMoney.sendTransaction("0x9e67dE2E43D539FE6900d4C90b2B47628a237440", {
                    from: this.state.web3.eth.accounts[0],
    ...
    render() {
        ...
        if (this.state.showContent) {
            content = <main className="container">
                ...
                <section className="buttons">
                    ...
                    <br/>
                    <button className="buy-button" onClick={this.goForPayment}>Jetzt kaufen</button>
                    <br/>
            ...
            content= <Payment goBack={this.backToContent}/>;
        }
        return (
            <div className="App">
                <Header/>
